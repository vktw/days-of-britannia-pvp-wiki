...
4. Use `.patchnotes` para ler a versão atual dentro do jogo.
5. Use `.pvpcamp` quando quiser montar um kit de treino.
6. Use `.arena` para desafios oficiais ou treinamento contra o PvP Trainer.
