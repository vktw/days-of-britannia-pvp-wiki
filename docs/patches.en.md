...
- The **Trailseeker Cloak**, made from DoB Cloth, costs 100 Cloth and 20 Dragon Blood. Crafting and wearing require 100.0 base Tracking. Correction to the live chance: base Tailoring success is **50% at 80.0**, rises linearly, and reaches 100% at 110.0; an eligible Talisman may add its bonus. The cloak grants +25 tiles and +4 targets to Tracking, and its tooltip reports the bonus.
...
- The **Thieving Cape**, made with DoB Cloth, hides a thief's gray status from viewers who have not revealed the wearer for up to 1 hour while worn. Crafting and wearing require 100 base Hiding, Stealth, Snooping, and Stealing; the recipe uses 100 Cloth, 100 Bloodmoss, 100 Garlic, 100 Nightshade, and 15 Dragon Blood. Base Tailoring success, before an eligible Talisman bonus, is 50% at 75.0 and rises linearly to 100% at 110.0. Forensic Evaluation reveals the wearer for 10 minutes.
