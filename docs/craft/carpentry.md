...
<section class="dob-craft-simulator" data-dob-craft-simulator data-craft-sim-skill="Carpentry" data-craft-sim-slider-max="105" aria-labelledby="dob-craft-carpentry-title">
  <div class="dob-craft-simulator__heading">
    ...
    <p>0.40.0 · Carpentry usa Carpentry como skill-base e cobre peças de madeira, armas, móveis e receitas especiais. Masonry é um menu separado, mas o servidor usa Carpentry como skill-base para ele; a relação está explicada em Masonry .</p>
  </div>
