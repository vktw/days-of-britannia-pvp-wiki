...
<section class="dob-craft-simulator" data-dob-craft-simulator data-craft-sim-skill="Tailoring" data-craft-sim-slider-max="105" aria-labelledby="dob-craft-tailoring-title">
  <div class="dob-craft-simulator__heading">
    ...
    <p>Beta 0.32.0 · Tailoring usa Tailoring como skill-base para roupas, couro, quivers e belts. Algumas receitas especiais forçam um resultado sem Exceptional ou começam com uma chance de sucesso diferente da base do sistema.</p>
  </div>
  ...
  <div class="dob-craft-simulator__layout" data-craft-sim-screen="recipes" hidden>
    ...
    <div class="dob-craft-simulator__workbench" data-craft-sim-workbench hidden>
      ...
      <div class="dob-craft-simulator__fields">
        ...
        <label for="dob-craft-tailoring-skill">Skill base de consulta
      ...
      <p id="dob-craft-tailoring-help" class="dob-craft-simulator__help">Quivers e belts exigem suas receitas quando o catálogo as marca como aprendidas. Exceptional não é sinônimo de chance de craft: confira a coluna de cada receita e o resultado do gump.</p>
      <p id="dob-craft-tailoring-note" class="dob-craft-simulator__note" data-craft-sim-note>Escolha uma receita para consultar sua curva publicada.</p>
    </div>
  </div>
</section>
