...
<section class="dob-craft-simulator" data-dob-craft-simulator data-craft-sim-skill="Carpentry" data-craft-sim-slider-max="105" aria-labelledby="dob-craft-carpentry-title">
  <div class="dob-craft-simulator__heading">
    ...
    <p>Beta 0.31.1 · Carpentry uses Carpentry as its base skill and covers wooden pieces, weapons, furniture, and special recipes. Masonry is a separate menu, but the server uses Carpentry as its base skill; the relationship is explained on Masonry .</p>
  </div>
